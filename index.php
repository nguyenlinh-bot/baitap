...
<body>
    ...
    if (isset($_GET['category'])) {
        ...
        $items_Database = new Items_Database();
        $items = $items_Database->getItemsByCategory($category);
    } elseif (isset($_GET['keyword'])) {
        $keyword = $_GET['keyword'];
        $items = $items_Database->search($keyword);
    } else {
        $items = $items_Database->getAllItems();
    }
                ...
                <div class="col mb-4">
                    <div class="card h-100">
                        ...
                        <a href="single.php?id=<?= $item['id'] ?>">
                            <img class="card-img-top" src="img/<?= $item['image'] ?>" alt="..." />
                        </a>
                        <!-- Product details-->
                        ...
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="single.php?id=<?= $item['id'] ?>">Details</a></div>
                        </div>
                    </div>
                </div>
            <?php endforeach ?>
