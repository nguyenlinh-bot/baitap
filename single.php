...
<body>
    ...
    if(isset($_GET['id'])){
        $id = $_GET['id'];
        $items_Database = new Items_Database();
        $itemsByID = $items_Database->getItemsByID($id);
    }
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="position-relative mb-3">
                        <img class="img-fluid w-100" src="img/<?=$itemsByID['image']?>" style="object-fit: cover;">
                        <div class="bg-white border border-top-0 p-4">
                            <div class="mb-3">
                                <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                                    href="">Business</a>
                                <a class="text-body" href=""><?=$itemsByID['created_at']?></a>
                            </div>
                            <h1 class="mb-3 text-secondary text-uppercase font-weight-bold"><?= $itemsByID['title']?></h1>
                            <p><?=$itemsByID['excerpt']?></p>
                            <p></p>
                            <h3 class="text-uppercase font-weight-bold mb-3"><?= $itemsByID['title']?></h3>
                            <img class="img-fluid w-50 float-left mr-4 mb-2" src="img/<?=$itemsByID['image']?>">
                            <p><?=$itemsByID['content']?></p>
                            <h5 class="text-uppercase font-weight-bold mb-3"><?= $itemsByID['title']?></h5>
                            <p></p>
                        </div>
